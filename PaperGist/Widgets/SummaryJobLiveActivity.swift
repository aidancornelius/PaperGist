...
struct LockScreenLiveActivityView: View {
    ...
    var body: some View {
        VStack(spacing: 12) {
            ...
            // Progress message
            if let message = context.state.progressMessage {
                Text(message)
...
/// Compact leading view - shows progress percentage
...
/// Compact trailing view - shows item count
...
/// Minimal view - just progress indicator
...
/// Expanded bottom view with full progress bar
...
/// Reusable stat view for displaying metrics
